...
$sql = "SELECT motor.*, merek2.* from motor, merek2 WHERE merek2.id_merek=motor.id_merek AND motor.id_motor='$vhid'";
...
<section class="listing-detail">
  <div class="container">
    <div class="listing_detail_head row">
      <div class="col-md-9">
        <h2><?php echo htmlentities($result['nama_merek']);?>, <?php echo htmlentities($result['nama_motor']);?></h2>
      </div>
      <div class="col-md-3">
